...
private:
  struct HostInfo {
    HostInfo(const Extensions::Common::DynamicForwardProxy::DnsCache::SharedHostInfoSharedPtr&
                 shared_host_info,
             const Upstream::LogicalHostSharedPtr& logical_host)
        : shared_host_info_(shared_host_info), logical_host_(logical_host) {}

    const Extensions::Common::DynamicForwardProxy::DnsCache::SharedHostInfoSharedPtr
        shared_host_info_;
