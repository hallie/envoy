...
config:
  dns_cache_config:
    ...
    config_helper_.addConfigModifier([](envoy::config::bootstrap::v2::Bootstrap& bootstrap) {
      ...
      auto* dns_cache_config = config.mutable_dns_cache_config();
      dns_cache_config->set_name("foo");
      switch (GetParam()) {
      case Network::Address::IpVersion::v4:
        dns_cache_config->set_dns_lookup_family(envoy::api::v2::Cluster::V4_ONLY);
        break;
      case Network::Address::IpVersion::v6:
        dns_cache_config->set_dns_lookup_family(envoy::api::v2::Cluster::V6_ONLY);
        break;
      }
